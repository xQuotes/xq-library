        ...
        k = function() {
            ...
            return r(e, [{
                ...
                default.one(e)) {
                        ...
                        document.documentElement.appendChild(t.children[0])
                    }
                    this.$dom = v.
                default.one(e);
                    var o = v.
            ...
            },
            {
                ...
                value: function(e) {
                    ...
                    default, {
                        ...
                        v.
                    default.one(".vc-tabbar", t.$dom).appendChild(n);
                        var l = v.
                    default.render(m.
                    default, {
                            id: e.id
                        });
                        o && (d.isString(o) ? l.innerHTML += o: d.isFunction(o.appendTo) ? o.appendTo(l) : d.isElement(o) && l.appendChild(o)),
                        v.
                    default.one(".vc-content", t.$dom).appendChild(l)
                    }),
                    e.trigger("addTopBar",
                    function(o) {
                        if (o) for (var n = v.
            ...
            function o(e) {
                if (d(e)) {
                    ...
                    for (var b = 0; b < g.length; b++) {
                        var h = g[b];
                        e.hasOwnProperty && !e.hasOwnProperty(h) || (v += h + ": ", o(e[h], e), b < g.length - 1 && (v += ", "))
                    }
                    f--,
                    v += "}",
                    p.pop()
            ...
            },
            {
                ...
                value: function(e) {
                    ...
                    default.one(".vc-item-content", a), d = 0; d < t.length; d++) {
                        ...
                        u.isObject(e.content) && s.appendChild(e.content),
                        f.
                    default.one(".vc-log", this.$tabbox).appendChild(a),
                    ...
                    default.one(".vc-fold-inner", i);
                        if (0 == n.children.length && e) {
                            ...
                            if (u.isObject(e)) {
                                var b = e.__proto__,
                                h = void 0;
                                h = u.isObject(b) ? o.getFoldedLine(b, f.
                            default.render(w.
                            default, {
                                    key: "__proto__",
                                    keyType: "private",
    ...
    function(e, t, o) {
        ...
        w = function(e) {
            ...
            },
            {
                ...
                default.one(".vc-log", this.$tabbox).appendChild(r),
                    this.domList[e] = r;
