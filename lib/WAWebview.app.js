...
function(e) {
    if ("function" == typeof logxx && logxx("jsbridge start"), !e.WeixinJSBridge) {
        ...
        m = function(e, t, n, i) {
            var o;
            o = e.indexOf(s) != -1 ? l[e] : a[e],
            "function" == typeof o && o(t, n, i)
        };
        e.WeixinJSBridge = {
            invoke: h,
...
var Reporter = function(e) {
    ...
    function r() { ! f || f.length <= 0 || (o("reportKeyValue", {
            dataArray: f
        }), f = [])
    }
    function a() { ! v || v.length <= 0 || (o("reportIDKey", {
            dataArray: v
        }), v = [])
    }
    function s() { ! m || m.length <= 0 || (o("systemLog", {
            dataArray: m
        }), m = [])
    }
    function l() {
        ...
        errorReport: function(e) {
            ...
            if (u.ErrorType[t]) {
                ...
                if (console.error(l), "undefined" != typeof window && "undefined" != typeof window.__webviewId__ ? WeixinJSBridge.publish("WEBVIEW_ERROR_MSG", {
                    ...
                    I[c] || (I[c] = 0),
                    I[c]++,
                    "thirdScriptError" === t && I[c] > B || I[c] > D || (R.reportIDKey({
                        key: t
                    }), R.reportKeyValue({
                        key: "Error",
                        value: c
...
wx = function(e) {
    ...
    0 : function(e, t, n) {
        function i(e) {
            return c ? void(l[e] = u[e]) : void l.__defineGetter__(e,
            function() {
                return function() {
                    try {
        ...
        n(18);
        var l = {},
        c = "devtools" === (0, s.getPlatform)(),
        d = function(e, t) { (0, r.publish)("INVOKE_METHOD", {
                name: e,
                args: t
            })
        },
        u = {
            ...
            initReady: function() { (0, r.invokeMethod)("initReady")
            },
            ...
            showKeyboard: function(e) { (0, r.invokeMethod)("showKeyboard", e)
            },
            showDatePickerView: function(e) { (0, r.invokeMethod)("showDatePickerView", e)
            },
            hideKeyboard: function(e) { (0, r.invokeMethod)("hideKeyboard", e)
            },
            insertMap: function(e) { (0, r.invokeMethod)("insertMap", e)
            },
            removeMap: function(e) { (0, r.invokeMethod)("removeMap", e)
            },
            updateMapCovers: function(e) { (0, r.invokeMethod)("updateMapCovers", e)
            },
            ...
            getRealRoute: s.getRealRoute,
            getCurrentRoute: function(e) { (0, r.invokeMethod)("getCurrentRoute", e, {
            ...
            getLocalImgData: function(e) {
                "string" == typeof e.path ? u.getCurrentRoute({
                    success: function(t) {
                        var n = t.route;
                        e.path = (0, s.getRealRoute)(n || "index.html", e.path),
                        (0, r.invokeMethod)("getLocalImgData", e)
                    }
                }) : (0, r.invokeMethod)("getLocalImgData", e)
            },
            insertVideoPlayer: function(e) { (0, r.invokeMethod)("insertVideoPlayer", e)
            },
            removeVideoPlayer: function(e) { (0, r.invokeMethod)("removeVideoPlayer", e)
            },
            insertShareButton: function(e) { (0, r.invokeMethod)("insertShareButton", e)
            },
            updateShareButton: function(e) { (0, r.invokeMethod)("updateShareButton", e)
            },
            removeShareButton: function(e) { (0, r.invokeMethod)("removeShareButton", e)
            },
            onAppDataChange: function(e) { (0, r.publish)("pageReady", {}),
                (0, r.subscribe)("appDataChange",
                function(t) {
                    setTimeout(function() {
                        e(t)
                    },
            ...
            publishPageEvent: function(e, t) { (0, r.publish)("PAGE_EVENT", {
                    eventName: e,
                    data: t
                })
            },
            animationToStyle: s.animationToStyle
        };
        for (var h in u) i(h);
        e.exports = l
    },
    15 : function(e, t) {
        ...
        function s(e) {
            ...
            function(t) {
                ...
                "function" == typeof n.beforeAll && n.beforeAll(t),
                i ? ("function" == typeof n.beforeSuccess && n.beforeSuccess(t), "function" == typeof o.success && o.success(t), "function" == typeof n.afterSuccess && n.afterSuccess(t)) : r ? ("function" == typeof o.cancel && o.cancel(t), "function" == typeof n.cancel && n.cancel(t)) : a && ("function" == typeof o.fail && o.fail(t), "function" == typeof n.fail && n.fail(t)),
    ...
    16 : function(e, t, n) {
        function i(e) { (0, s.invokeMethod)("insertContactButton", e)
        }
        function o(e) { (0, s.invokeMethod)("updateContactButton", e)
        }
        function r(e) { (0, s.invokeMethod)("removeContactButton", e)
        }
        function a(e) { (0, s.invokeMethod)("enterContact", e)
        }
        Object.defineProperty(t, "__esModule", {
            value: !0
        }),
        t.insertContactButton = i,
        t.updateContactButton = o,
        t.removeContactButton = r,
        t.enterContact = a;
        var s = n(15)
    },
    17 : function(e, t) {
    ...
    18 : function(e, t, n) {
        ...
        a.forEach(function(e) { (0, o.subscribe)(e,
            function(t) {
                var n = t.log;
                console[e].apply(console, n)
            })
        }),
        (0, o.subscribe)("initLogs",
        function(e) {
            var t = e.logs;
        ...
        i(function() {
            setTimeout(function() { (0, o.publish)("DOMContentLoaded", {})
            },
            1e3)
        })
    }
...
exparser = function(e) {
    ...
    t.Component = s,
    t.Observer = d,
    t.registerBehavior = r.create,
    t.registerElement = s.register,
    t.createElement = s.create,
    t.createTextNode = l.create,
    t.createVirtualNode = c.create,
    t.appendChild = a.appendChild,
    t.insertBefore = a.insertBefore,
    t.removeChild = a.removeChild,
    t.replaceChild = a.replaceChild,
    t.addListenerToElement = o.addListenerToElement,
    t.removeListenerFromElement = o.removeListenerFromElement,
    t.triggerEvent = o.triggerEvent,
    t.addGlobalErrorListener = i.addGlobalErrorListener,
    t.removeGlobalErrorListener = i.removeGlobalErrorListener;
    var u = {
        renderingMode: "full",
        keepWhiteSpace: !1,
        parseTextContent: !0,
...
function(e, t) {
    ...
    n.prototype.remove = function(e) {
        ...
        if ("function" == typeof e) {
            for (n = 0; n < t.length; n++) if (t[n].func === e) return t.splice(n, 1),
            this.empty = !t.length,
            !0
        } else for (n = 0; n < t.length; n++) if (t[n].id === e) return t.splice(n, 1),
        this.empty = !t.length,
        !0;
        return ! 1
    },
...
function(e, t, n) {
    ...
    r = function(e, t, n, i) {
        ...
        m = u.parentNode, b = u; b && (m === b && (m = b.parentNode), b.__wxEvents && b.__wxEvents[t] && v(b.__wxEvents[t], b), !a && !c);) if (b.__host) {
            if (s) break;
            m && m.__domElement || (m = b.__host, g.target = m),
            b = b.__host
        } else {
            var A = !0; (b.__domElement || b.__virtual) && (A = !1),
            b = A || s ? b.parentNode: b.__slotParent
        }
    };
    t.addListenerToElement = function(e, t, n) {
        var o = e.__wxElement || e;
        return e === o.shadowRoot && (o = e),
        o.__wxEvents || (o.__wxEvents = Object.create(null)),
        o.__wxEvents[t] || (o.__wxEvents[t] = i.create("Event Listener")),
        o.__wxEvents[t].add(n)
    },
...
function(e, t, n) {
    ...
    o.list = Object.create(null),
    o.prototype.hasBehavior = function(e) {
...
function(e, t, n) {
    ...
    var s = function(e) {
        if (!e.parentNode || e.parentNode.__attached) {
            var t = function(e) {
                e.__attached = !0,
                e.shadowRoot instanceof r && t(e.shadowRoot);
                var n = e.childNodes;
                if (n) for (var i = 0; i < n.length; i++) t(n[i])
            };
            t(e);
            var n = function(e) {
                e.__lifeTimeFuncs && a._callLifeTimeFuncs(e, "attached"),
                e.shadowRoot instanceof r && n(e.shadowRoot);
                var t = e.childNodes;
    ...
    l = function(e) {
        if (e.__attached) {
            ...
            t(e);
            var n = function(e) {
                e.__lifeTimeFuncs && a._callLifeTimeFuncs(e, "detached"),
                e.shadowRoot instanceof r && n(e.shadowRoot);
                var t = e.childNodes;
                if (t) for (var i = 0; i < t.length; i++) n(t[i])
            };
    ...
    u = function(e, t, n, i) {
        ...
        t ? e.childNodes.splice(r, i ? 1 : 0, t) : e.childNodes.splice(r, i ? 1 : 0),
        i && (l(n), c(e, "remove", n)),
        t && (a && (l(t), c(a, "remove", t)), s(t), c(e, "add", t)),
        !0
    },
    h = function(e, t, n, i) {
        var o = i ? n: t,
...
function(e, t, n) {
    ...
    o.prototype.observe = function(e, t) {
        ...
        t.childList && (e.__childObservers || (e.__childObservers = i.create("Observer Callback")), this._binded.push({
            funcArr: e.__childObservers,
            id: e.__childObservers.add(o),
            subtree: t.subtree ? e: null
        }), n++),
        t.characterData && (e.__textObservers || (e.__textObservers = i.create("Observer Callback")), this._binded.push({
    ...
    o.prototype.disconnect = function() {
        for (var e = this._binded,
        t = 0; t < e.length; t++) {
            var n = e[t];
            n.funcArr.remove(n.id),
            n.subtree && r(n.subtree, -1)
        }
        this._binded = []
    };
...
function(e, t, n) {
    ...
    a._setCompnentSystem(u),
    l._setCompnentSystem(u),
    u._setGlobalOptionsGetter = function(e) {
    ...
    u.register = function(e) {
        ...
        Object.keys(i.properties).forEach(function(e) {
            ...
            void 0 === t.value && (t.type === String ? t.value = "": t.type === Number ? t.value = 0 : t.type === Boolean ? t.value = !1 : t.type === Array ? t.value = [] : t.value = null),
            r[e] = {
                type: t.type,
                value: t.value,
        ...
        v = {};
        for (var m in r) v[m] = r[m].value,
        f[m] = !!r[m].public;
        var b = document.getElementById(i.is); ! i.template && b && "TEMPLATE" === b.tagName || (b = document.createElement("template"), b.innerHTML = i.template || "");
    ...
    u.create = function(e) {
        ...
        o.shadowRoot instanceof l ? (l._attachShadowRoot(i, o.shadowRoot), i.shadowRoot = o.shadowRoot, i.__slotChildren = [o.shadowRoot], o.shadowRoot.__slotParent = i) : (i.__domElement.appendChild(o.shadowRoot), i.shadowRoot = t, i.__slotChildren = t.childNodes),
        ...
        return u._callLifeTimeFuncs(i, "created"),
        i
    },
...
function(e, t, n) {
    ...
    function r(e, t, n, i, o) {
        ...
        p = 0; p < e.length; p++) {
            var g = e[p];
            if (void 0 === g.name) a = h.create(g.text),
            g.exp && o.add(g.exp, a.__domElement, "textContent", w),
            c.appendChild(t, a);
            else {
                var f = g.attrs;
                if ("virtual" === g.name) a = u.create(g.virtual);
                else if (g.custom) for (a = v.create(g.name), s = 0; s < f.length; s++) l = f[s],
                l.updater ? l.updater(a, l.name, l.value) : a.__behavior.properties[l.name].type === Boolean ? a[l.name] = !0 : a[l.name] = l.value,
                l.exp && o.add(l.exp, a, l.name, l.updater);
                else for (a = d.wrap(document.importNode(g.prerendered, !1)), s = 0; s < f.length; s++) l = f[s],
                o.add(l.exp, a.__domElement, l.name, l.updater);
                c.appendChild(t, a),
                g.id && (n[g.id] = a),
                void 0 !== g.slot && (i[g.slot] = a),
                r(g.children, a, n, i, o)
            }
        }
    }
    function a(e, t, n, i, o) {
        ...
        c = 0; c < e.length; c++) {
            var d = e[c];
            if (void 0 === d.name) r = document.createTextNode(d.text),
            d.exp && o.add(d.exp, r, "textContent", w),
            t.appendChild(r);
            else {
                var u = d.attrs;
                for (r = document.importNode(d.prerendered, !1), s = 0; s < u.length; s++) l = u[s],
                o.add(l.exp, r, l.name, l.updater);
                t.appendChild(r),
                d.id && (n[d.id] = r),
                void 0 !== d.slot && (i[d.slot] = r),
                a(d.children, r, n, i, o)
            }
        }
    }
    var s = n(8),
    ...
    g.create = function(e, t, n, r) {
                    ...
                    if (S) {
                        ...
                        B = 0; B < S.length; B++) {
                            ...
                            if ("id" === D.name) E = D.value;
                                ...
                                var P = void 0,
                                N = D.name;
                                D.name.slice( - 1) === p ? m ? (P = b, N = i(D.name.slice(0, -1))) : (P = y, N = D.name.slice(0, -1)) : ":" === D.name.slice( - 1) ? (P = m ? b: w, N = i(D.name.slice(0, -1))) : "class." === D.name.slice(0, 6) ? (P = m ? A: x, N = D.name.slice(6)) : "style." === D.name.slice(0, 6) && (P = m ? _: C, N = D.name.slice(6)),
                                P && (d = l.parse(D.value, n));
                        ...
                        e.push(R),
                        "VIRTUAL" === h.tagName && (R.virtual = "virtual"),
                        h.childNodes && v(R.children, h.childNodes, g, I),
                        1 === R.children.length && R.children[0] === c && (R.children.pop(), R.slot = "")
                    }
                } else f = !0,
                e.push(c);
                else {
                    ...
                    d = void 0,
                    a.parseTextContent && (d = l.parse(M, n)),
                    e.push({
                        exp: d,
        ...
        v(S, h.childNodes, [], u),
        f || S.push(c),
        1 === S.length && S[0] === c && S.pop();
        var T = Object.create(g.prototype);
        return T._tagTreeRoot = S,
        T._renderingMode = s,
        T
    },
    g.prototype.createInstance = function() {
        ...
        return "native" === this._renderingMode ? a(this._tagTreeRoot, o, t, n, i) : (o = u.create("shadow-root"), r(this._tagTreeRoot, o, t, n, i)),
        e.shadowRoot = o,
        e.idMap = t,
        e.slots = n,
        e._binding = i,
...
function(e, t) {
    ...
    n.create = function() {
        ...
        return e._bindings = Object.create(null),
        e
    },
...
function(e, t, n) {
    ...
    var r = function(e, t, n, o) {
        ...
        if (o.callee) {
            ...
            r = i.safeCallback("Template Method", n[o.prop], e, a),
            void 0 !== r && null !== r || (r = "")
        } else r = t[o.prop];
        return o.not ? !r: r
    };
    o.prototype.calculate = function(e, t) {
        ...
        i = null,
        o = "";
        if (this.isSingleVariable) i = n[1],
        o = r(e, t, this._methods, i);
        else for (var a = 0; a < n.length; a++) i = n[a],
        o += a % 2 ? r(e, t, this._methods, i) : i;
        return o
    },
    e.exports = o
},
...
function(e, t, n) {
    ...
    o.create = function(e) {
        var t = Object.create(o.prototype);
        return t.$$ = t.__domElement = document.createTextNode(e || ""),
    ...
    Object.defineProperty(o.prototype, "textContent", {
        ...
        set: function(e) {
            ...
            (this.__textObservers && !this.__textObservers.empty || this.__subtreeObserversCount) && i._callObservers(this, "__textObservers", {
                type: "characterData",
                target: this
            })
        }
...
function(e) {
    ...
    n = null; ["webkitAnimationStart", "webkitAnimationIteration", "webkitAnimationEnd", "animationstart", "animationiteration", "animationend", "webkitTransitionEnd", "transitionend"].forEach(function(i) {
        ...
        function(e) {
            e.target.__wxElement && exparser.triggerEvent(e.target.__wxElement, i, t(e)),
...
function(e) {
    ...
    t(function() {
        WeixinJSBridge.subscribe("onAppRouteDone",
        function() {
        ...
        WeixinJSBridge.subscribe("setKeyboardValue",
        function(e) {
        ...
        WeixinJSBridge.subscribe("hideKeyboard",
        function(e) {
        ...
        WeixinJSBridge.on("onKeyboardComplete",
        function(e) {
        ...
        WeixinJSBridge.on("onKeyboardConfirm",
        function(e) {
        ...
        WeixinJSBridge.on("onTextAreaHeightChange",
        function(e) {
        ...
        WeixinJSBridge.on("onKeyboardShow",
        function(e) {
...
function(e) {
    ...
    function(e) {
        exparser.triggerEvent(e.target, "focus"),
        e.preventDefault()
    },
    !0),
...
function(e) {
    ...
    function(e) {
        s = !0,
        n(e, "touchstart"),
        1 === e.touches.length && v(e, e.touches[0].pageX, e.touches[0].pageY)
    },
    !0),
    e.addEventListener("touchmove",
    function(e) {
        n(e, "touchmove"),
        1 === e.touches.length && m(e, e.touches[0].pageX, e.touches[0].pageY)
    },
    !0),
    e.addEventListener("touchend",
    function(e) {
        n(e, "touchend"),
        0 === e.touches.length && b(e, e.changedTouches[0].pageX, e.changedTouches[0].pageY)
    },
    !0),
    ...
    function(e) { ! s && l && (a(e, !1), n(e, "touchmove"), m(e, e.pageX, e.pageY))
    },
    !0),
    e.addEventListener("mouseup",
    function(e) { ! s && l && (a(e, !0), n(e, "touchend"), b(e, e.pageX, e.pageY))
    },
    !0);
    var A = {},
    _ = function(e) {
        if (A.selector) for (var t = A.selector,
        n = e.target; n;) {
    ...
    w = function(e, n) {
        for (var i = 0; i < A.data.length; i++) {
            ...
            if (o.element === n) {
                ...
                0 === n.indexOf(".") && (r.index = Array.prototype.indexOf.call(document.body.querySelectorAll(o.element), e)),
                t(function() {
    ...
    t(function() {
        WeixinJSBridge.subscribe("analyticsConfig",
        function(e) {
...
window.exparser.registerBehavior({
    ...
    _handleItemAdded: function(e) {
        return e.detail.item._relatedGroup = this,
        this.addItem(e.detail.item),
        !1
    },
    _handleItemRemoved: function(e) {
        return this.removeItem(e.detail.item),
        !1
    },
...
window.exparser.registerBehavior({
    ...
    hoverTouchStart: function(e) {
        ...
        if (this.__touch = !0, "none" == this.hoverStyle || "none" == this.hoverClass || this.disabled);
            ...
            window.__hoverElement__ && (window.__hoverElement__._hoverReset(), window.__hoverElement__ = void 0),
            this.__hoverStyleTimeId = setTimeout(function() {
                t.__hovering = !0,
                window.__hoverElement__ = t,
                "none" == t.hoverClass || "none" == t.hoverStyle || (t.hoverClass ? t.$$.classList.add(t.hoverClass) : t.$$.classList.add(t.is.replace("wx-", "") + "-hover")),
                t.__touch || window.requestAnimationFrame(function() {
                    clearTimeout(t.__hoverStayTimeId),
                    t.__hoverStayTimeId = setTimeout(function() {
                        t._hoverReset()
                    },
                    t.hoverStayTime)
                })
    ...
    hoverTouchEnd: function() {
        var e = this;
        this.__touch = !1,
        this.__hovering && (clearTimeout(this.__hoverStayTimeId), window.requestAnimationFrame(function() {
...
window.exparser.registerBehavior({
    ...
    _focusChange: function(e) {
        return this._couldFocus(e),
        e
    },
    _couldFocus: function(e) {
        var t = this; ! this._keyboardShow && this._attached && e && (window.requestAnimationFrame = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame, window.requestAnimationFrame ? window.requestAnimationFrame(function() {
            t._inputFocus()
        }) : this._inputFocus())
    },
...
window.exparser.registerBehavior({
    ...
    moved: function() {
        this._relatedGroup && (this._relatedGroup.triggerEvent("wxItemRemoved"), this._relatedGroup = null),
        this.triggerEvent("wxItemAdded", {
            item: this
        },
        {
...
window.exparser.registerBehavior({
    ...
    attached: function() {
        ...
        function(e) {
            e.stopPropagation(),
            Math.abs(t.currentTime - r) % t.duration >= 1 && (n._publish("timeupdate", {
        ...
        t.addEventListener("durationchange",
        function() {
...
exparser.registerBehavior({
    ...
    touchtrack: function(e, t) {
        ...
        l = null;
        exparser.addListenerToElement(e, "touchstart",
        function(e) {
            if (1 === e.touches.length && !l) return l = e,
            i = r = e.touches[0].pageX,
            o = a = e.touches[0].pageY,
            s(e, "start", i, o)
        }),
        exparser.addListenerToElement(e, "touchmove",
        function(e) {
            if (1 === e.touches.length && l) {
                var t = s(e, "move", e.touches[0].pageX, e.touches[0].pageY);
                return r = e.touches[0].pageX,
                a = e.touches[0].pageY,
                t
            }
        }),
        exparser.addListenerToElement(e, "touchend",
        function(e) {
            if (0 === e.touches.length && l) return l = null,
            s(e, "end", e.changedTouches[0].pageX, e.changedTouches[0].pageY)
        }),
        exparser.addListenerToElement(e, "touchcancel",
        function(e) {
            if (0 === e.touches.length && l) {
                var t = l;
                return l = null,
                s(e, "end", t.touches[0].pageX, t.touches[0].pageY)
            }
        })
    }
}),
...
window.exparser.registerElement({
    ...
    actionChanged: function(e, t) {
        if (e) {
            ...
            if (null != (i = /^set([a-z|A-Z]*)/.exec(n))) {
                ...
                "playbackRate" == o || "currentTime" == o ? this.$.player[o] = r: "src" === o ? this.srcChanged(r) : this.triggerEvent("error", {
    ...
    attached: function() {
        ...
        WeixinJSBridge.subscribe("audio_" + this.id + "_actionChanged",
        function(t) {
            e.action = t
        }),
...
window.exparser.registerElement({
    ...
    attached: function() {
        ...
        t = (this.$.canvas, this);
        if (this._images = {},
        this._box = this._getBox(), this.$.canvas.width = this.$$.offsetWidth, this.$.canvas.height = this.$$.offsetHeight, !this.canvasId) return this.triggerEvent("error", {
        ...
        }), this._isError = !0, void(this.$$.style.display = "none")) : (window.__canvasNumber__ = window.__canvasNumber__ || 1e5, window.__canvasNumbers__[n] = window.__canvasNumber__ + __webviewId__, window.__canvasNumber__ += 1e5, this._canvasNumber = window.__canvasNumbers__[n], void(this._isMobile() ? !
        function() {
            t._isReady = !1;
            var n = {
                target: {
            ...
            function(e) {
                ...
                t._ready(),
                document.addEventListener("pageReRender", t._pageReRenderCallback.bind(t))
            })
        } () : (WeixinJSBridge.publish("canvasInsert", {
            canvasId: t.canvasId,
            canvasNumber: t._canvasNumber
        }), WeixinJSBridge.subscribe("canvas" + t._canvasNumber + "actionsChanged",
        function(e) {
            var n = e.actions,
            i = e.reserve;
            t.actions = n,
            t.actionsChanged(n, i)
        }), WeixinJSBridge.subscribe("invokeCanvasToDataUrl",
        function() {
    ...
    detached: function() {
        ...
        delete window.__canvasNumbers__[e],
        this._isMobile() && WeixinJSBridge.invoke("removeCanvas", {
            canvasId: this._canvasNumber
        },
        function(e) {}),
    ...
    addTouchEventForWebview: function() {
        ...
        touchEventNames.forEach(function(t) {
            ...
            function(n) {
                ...
                e.bindlongtap && (e._touchInfo = e._touchInfo || {},
                e._disableScroll = e._disableScroll || 0, "touchstart" === t ? o.forEach(function(t) {
                    e._touchInfo[t.identifier] = {},
                    e._touchInfo[t.identifier].x = t.x,
                    e._touchInfo[t.identifier].y = t.y,
                    e._touchInfo[t.identifier].timeStamp = n.timeStamp,
                    e._touchInfo[t.identifier].handler = setTimeout(function() {
                        if (e._touchInfo.hasOwnProperty(t.identifier)) {
                            e._touchInfo[t.identifier].longPress = !0,
                            ++e._disableScroll;
                            var i = [],
                            o = [];
                            for (var r in e._touchInfo) {
                                ...
                                i.push(a),
                                r === String(t.identifier) && o.push(a)
                            }
                    ...
                    e._touchInfo.hasOwnProperty(n.identifier) || console.error("in " + t + ", can not found " + n.identifier + " in " + JSON.stringify(e._touchInfo)),
                    e._touchInfo[n.identifier].longPress && --e._disableScroll,
                    clearTimeout(e._touchInfo[n.identifier].handler),
                    delete e._touchInfo[n.identifier]
                }) : o.forEach(function(n) {
                    e._touchInfo.hasOwnProperty(n.identifier) || console.error("in " + t + ", can not found " + n.identifier + " in " + JSON.stringify(e._touchInfo)),
                    calcDistance(e._touchInfo[n.identifier], n) > LONG_PRESS_DISTANCE_THRESHOLD && !e._touchInfo[n.identifier].longPress && clearTimeout(e._touchInfo[n.identifier].handler),
                    e._touchInfo[n.identifier].x = n.x,
                    e._touchInfo[n.identifier].y = n.y
                })),
    ...
    actionsChanged: function(e) {
        ...
        if (!this._isMobile() && e) {
            var n = this.$.canvas,
            i = n.getContext("2d");
            t === !1 && (i.fillStyle = "#000000", i.strokeStyle = "#000000", i.shadowColor = "#000000", i.shadowBlur = 0, i.shadowOffsetX = 0, i.shadowOffsetY = 0, i.setTransform(1, 0, 0, 1, 0, 0), i.clearRect(0, 0, n.width, n.height)),
            e.forEach(function(e) {
                ...
                }), i[n]()) : "fillText" === n ? i.fillText.apply(i, o) : "drawImage" === n ? !
                function() {
                    var e = _toArray(o),
                    n = e[0],
                    r = e.slice(1);
                    ...
                    t._images[n] ? i.drawImage.apply(i, [t._images[n]].concat(_toConsumableArray(r))) : (t._images[n] = new Image, t._images[n].src = n, t._images[n].onload = function() {
...
window.exparser.registerElement({
    ...
    attached: function() {
        ...
        if (this._isMobile(), 1) {
            var t = void 0;
            t = buttonTypes[this.type] ? buttonTypes[this.type] : buttonTypes["default-dark"],
            this.$.wrapper.style.backgroundImage = "url('" + t + "')",
        ...
        wx.insertContactButton({
            ...
            complete: function(t) {
                console.log("insertContactButton complete", t),
                e.contactButtonId = t.contactButtonId,
                document.addEventListener("pageReRender", e._pageReRender.bind(e), !1)
            }
        })
    },
    detached: function() {
        this._isMobile(),
        1,
        currentContactButton === this && (currentContactButton = null)
    },
    ...
    typeChanged: function(e, t) {
        if (this._isMobile(), 1) {
            var n = void 0;
            n = buttonTypes[this.type] ? buttonTypes[this.type] : buttonTypes["default-dark"],
            this.$.wrapper.style.backgroundImage = "url('" + n + "')"
    ...
    _getBox: function() {
        ...
        t = this.size;
        "number" != typeof t && (t = MIN_SIZE),
        t = t > MAX_SIZE ? MAX_SIZE: t,
        t = t < MIN_SIZE ? MIN_SIZE: t;
        var n = {
            left: e.left + window.scrollX,
            top: e.top + window.scrollY,
            width: t,
    ...
    asyncDfs: function(e, t) {
        ...
        r = 0; r < e.childNodes.length; ++r) {
            ...
            function(e) {
                n.getFormData(e,
                function(t) {
                    "undefined" != typeof t && (n._data[e.name] = t),
                    n.asyncDfs(e,
                    function() {
                        0 == --o && i()
                    })
    ...
    submitHandler: function(e) {
        ...
        function() {
            t.reportSubmit ? t._isDevTools() ? t.triggerEvent("submit", {
                ...
                target: n
            }) : WeixinJSBridge.invoke("reportSubmitForm", {},
            function(e) {
...
window.exparser.registerElement({
    ...
    _srcChanged: function(e) {
        this._img.src = e,
        this.$.div.style.backgroundImage = "url('" + e + "')"
    },
    srcChanged: function(e, t) {
        if (e) {
...
function() { / wechatdevtools / .test(window.navigator.userAgent.toLowerCase()) && window.exparser.registerElement({
        is: "wx-input",
        ...
        attached: function() {
            ...
            this._attached = !0,
            this.updateInput(),
            window.__onAppRouteDone && this._couldFocus(this.autoFocus || this.focus),
            this.__routeDoneId = exparser.addListenerToElement(document, "routeDone",
            function() {
                e._couldFocus(e.autoFocus || e.focus)
            }),
            this.__setKeyboardValueId = exparser.addListenerToElement(document, "setKeyboardValue",
            function(t) {
                if (e._keyboardShow) {
            ...
            this.__hideKeyboardId = exparser.addListenerToElement(document, "hideKeyboard",
            function(t) {
            ...
            (this.autoFocus || this.focus) && setTimeout(function() {
                e._couldFocus(e.autoFocus || e.focus)
            },
            500)
        },
...
function() { / wechatdevtools / .test(window.navigator.userAgent.toLowerCase()) || window.exparser.registerElement({
        ...
        _couldFocus: function(e) {
            var t = this; ! this._keyboardShow && this._attached && e && window.requestAnimationFrame(function() {
                t._inputFocus()
            })
        },
        _getPlaceholderClass: function(e) {
        ...
        attached: function() {
            ...
            this.__onKeyboardCompleteId = exparser.addListenerToElement(document, "onKeyboardComplete",
            function(t) {
            ...
            this.__onKeyboardConfirmId = exparser.addListenerToElement(document, "onKeyboardConfirm", this.onKeyboardConfirm.bind(this)),
        ...
        detached: function() {
            ...
            exparser.removeListenerFromElement(document, "onKeyboardComplete", this.__onKeyboardCompleteId),
            exparser.removeListenerFromElement(document, "setKeyboardValue", this.__setKeyboardValueId),
            exparser.removeListenerFromElement(document, "onKeyboardConfirm", this.__onKeyboardConfirmId),
        ...
        onKeyboardComplete: function() {
            this.__formResetCallback && (this.value = "", this.__formResetCallback = void 0),
        ...
        defaultValueChange: function(e, t) {
            return this.maxlength > 0 && (e = e.slice(0, this.maxlength)),
            e != this.value && (this._inputId && this._keyboardShow ? WeixinJSBridge.invoke("updateInput", {
                value: e || "",
                inputId: this._inputId
            },
            function(e) {}) : this._checkPlaceholderStyle(e)),
            e
        },
        _showNativeInput: function(e) {
            ...
            console.info("showKeyboard", this.inputArgs),
            WeixinJSBridge.invoke("showKeyboard", this.inputArgs,
            function(e) { / :ok / .test(e.errMsg) ? (t._inputId = e.inputId, t._keyboardShow = !0, t.showValue = " ") : console.info(e.errMsg)
            })
        },
        _diff: function(e, t) {
            var n = {},
        ...
        formateEventTarget: function() {
            ...
            this.bindinput ? JSON.stringify(e) : ""
        },
        _updateInput: function() {
            if (this._keyboardShow) {
                ...
                t && (this.inputArgs = e, t.inputId = this._inputId, WeixinJSBridge.invoke("updateInput", t,
                function(e) {}))
            }
        },
        ...
        _checkPlaceholderStyle: function(e) {
            var t = e || " ";
            e ? ((this.password || "password" == this.type) && (t = e ? new Array(e.length + 1).join("●") : ""), this.showValue = t, this.$.input.classList.remove("input-placeholder"), this.placeholderClass && this.$.input.classList.remove(this.placeholderClass), this.$.input.setAttribute("style", ""), this.checkLineHeight()) : (this.placeholder && (this.$.input.classList.add("input-placeholder"), this.placeholderClass && this.$.input.classList.add(this.placeholderClass), this.placeholderStyle && this.$.input.setAttribute("style", this.placeholderStyle), this.checkLineHeight(), t = this.placeholder), this.showValue = t)
        }
    })
} (),
window.exparser.registerElement({
...
function() {
    "wechatdevtools" === wx.getPlatform() && (window.addEventListener("DOMContentLoaded",
    function() {
        var e = document.createElement("script");
        e.type = "text/javascript",
        e.src = "https://map.qq.com/api/js?v=2.exp&callback=__map_jssdk_init",
...
window.exparser.registerElement({
    ...
    _update: function(e, t) {
        e.mapId = this._mapId,
        e.hide = this.hidden,
        WeixinJSBridge.invoke("updateMap", e,
        function(e) {})
    },
    _updatePosition: function() {
    ...
    _insertNativeMap: function() {
        ...
        this._canInvokeNewFeature || (t.markers = this.markers || []),
        WeixinJSBridge.invoke("insertMap", t,
        function(t) { / ok / .test(t.errMsg) ? (e._mapId = t.mapId, e._ready(), e._canInvokeNewFeature && WeixinJSBridge.publish("mapInsert", {
                domId: e.id,
                mapId: e._mapId,
    ...
    _insertIframeMap: function() {
        ...
        n = !1,
        i = !1;
        qq.maps.event.addListener(t, "click",
        function() {
            e.bindtap && wx.publishPageEvent(e.bindtap, {})
        }),
        qq.maps.event.addListener(t, "drag",
        function() {
            e.bindregionchange && !n && (wx.publishPageEvent(e.bindregionchange, {
                type: "begin"
            }), n = !0, i = !1)
        }),
        qq.maps.event.addListener(t, "dragend",
        function() {
            n && (n = !1, i = !0)
        }),
        qq.maps.event.addListener(t, "bounds_changed",
        function() {
            e.bindregionchange && i && (wx.publishPageEvent(e.bindregionchange, {
                type: "end"
            }), i = !1)
        });
        var o = qq.maps.event.addListener(t, "tilesloaded",
        function() {
            e._mapId = __map_jssdk_id++,
            e._ready(),
            WeixinJSBridge.subscribe("doMapAction" + e._mapId,
            function(t) {
                ...
                } else "moveToMapLocation" === t.data.method && e.showLocation && WeixinJSBridge.invoke("private_geolocation", {},
                function(t) {
                    try {
                        t = JSON.parse(t)
                    } catch(e) {
                    ...
                    if (t.result && t.result.location) {
                        ...
                        e._posOverlay && e._posOverlay.setMap(null),
                        e._posOverlay = new e.CustomOverlay(new qq.maps.LatLng(n.lat, n.lng)),
                        e._posOverlay.setMap(e._map),
                        e._map.panTo(new qq.maps.LatLng(n.lat, n.lng))
                    }
                })
            }),
            ...
            qq.maps.event.removeListener(o),
            o = null
        }),
        ...
        r.prototype = new qq.maps.Overlay,
        r.prototype.construct = function() {
            ...
            t.setAttribute("style", "position: absolute;width: 16px;height: 16px;background: white;border-radius: 8px;top: 8px;left: 8px;"),
            e.appendChild(t);
            var n = document.createElement("div");
            n.setAttribute("style", "position: absolute;width: 12px;height: 12px;background: rgb(31, 154, 228);border-radius: 6px;top: 2px;left: 2px;"),
            t.appendChild(n);
            var i = this.getPanes();
    ...
    coversChanged: function() {
        ...
        return this._isReady ? void(this._isMobile() ? wx.getCurrentRoute({
            ...
            return t.iconPath && n.setIcon(new qq.maps.MarkerImage(t.iconPath)),
            n
    ...
    markersChanged: function() {
        ...
        return this._isReady ? void(this._isMobile() ? wx.getCurrentRoute({
            ...
            return t.iconPath && (Number(t.width) && Number(t.height) ? n.setIcon(new qq.maps.MarkerImage(t.iconPath, new qq.maps.Size(t.width, t.height), new qq.maps.Point(0, 0), new qq.maps.Point(t.width / 2, t.height), new qq.maps.Size(t.width, t.height))) : n.setIcon(new qq.maps.MarkerImage(t.iconPath))),
            (t.title || t.name) && n.setTitle(t.title || t.name),
            e.bindmarkertap && "undefined" != typeof t.id && qq.maps.event.addListener(n, "click",
            function(n) {
                var i = n.event;
    ...
    controlsChanged: function() {
        ...
        function() {
            ...
            t.forEach(function(t) {
                ...
                i.style.zIndex = 9999,
                i.src = t.iconPath,
                t.clickable && "undefined" != typeof t.id && (i.onclick = function() {
    ...
    showLocationChanged: function() {
        ...
        return this._isReady ? void(this._isMobile() ? this._update({
            showLocation: t
        }) : (this._posOverlay && (this._posOverlay.setMap(null), this._posOverlay = null), t && WeixinJSBridge.invoke("private_geolocation", {},
        function(t) {
            try {
                t = JSON.parse(t)
            } catch(e) {
...
window.exparser.registerElement({
    ...
    _initColumns: function() {
        ...
        t.forEach(function(t, n) {
            t._setStyle(e.indicatorStyle),
            t._setHeight(e.$$.offsetHeight),
            t._setCurrent(i[n] || 0),
            t._init()
        })
    },
    ...
    _valueChanged: function() {
        var e = arguments.length <= 0 || void 0 === arguments[0] ? [] : arguments[0]; (this._columns || []).forEach(function(t, n) {
            t._setCurrent(e[n] || 0),
            t._update()
        })
    }
...
function() {
    function e(e, t, n) {
        function i(t, n, o, r) {
            if (!t || !t.cancelled) {
                o(n);
                var a = e.done();
                a || t.cancelled || (t.id = requestAnimationFrame(i.bind(null, t, n, o, r))),
                a && r && r(n)
            }
        }
        function o(e) {
    ...
    function r(e) {
        this._extent = e,
        this._friction = new t(.01),
        this._spring = new o(1, 90, 20),
        this._startTime = 0,
        this._springing = !1,
    ...
    function a(e, t, n) {
        ...
        this._position = i,
        this._scroll = new r(this._extent),
    ...
    t.prototype.x = function(e) {
        ...
        var t;
        return t = e === this._dt && this._powDragDt ? this._powDragDt: this._powDragDt = Math.pow(this._drag, e),
        this._dt = e,
    ...
    o.prototype.setEnd = function(e, t, n) {
        if (n || (n = (new Date).getTime()), e != this._endPosition || !i(t, s)) {
            ...
            this._solution && (i(t, s) && (t = this._solution.dx((n - this._startTime) / 1e3)), o = this._solution.x((n - this._startTime) / 1e3), i(t, s) && (t = 0), i(o, s) && (o = 0), o += this._endPosition),
            this._solution && i(o - e, s) && i(t, s) || (this._endPosition = e, this._solution = this._solve(o - this._endPosition, t), this._startTime = n)
        }
    },
    ...
    r.prototype.set = function(e, t) {
        ...
        e > 0 && t >= 0 ? (this._springOffset = 0, this._springing = !0, this._spring.snap(e), this._spring.setEnd(0)) : e < -this._extent && t <= 0 ? (this._springOffset = 0, this._springing = !0, this._spring.snap(e), this._spring.setEnd( - this._extent)) : this._springing = !1,
        this._startTime = (new Date).getTime()
    },
    r.prototype.x = function(e) {
        ...
        n = this.dx(e);
        return (t > 0 && n >= 0 || t < -this._extent && n <= 0) && (this._springing = !0, this._spring.setEnd(0, n), t < -this._extent ? this._springOffset = -this._extent: this._springOffset = 0, t = this._spring.x() + this._springOffset),
        t
    },
    ...
    r.prototype.configuration = function() {
        ...
        return e.push.apply(e, this._spring.configuration()),
        e
    };
    var l = .5;
    ...
    a.prototype.onTouchMove = function(e, t) {
        ...
        n > 0 ? n *= l: n < -this._extent && (n = (n + this._extent) * l - this._extent),
        this._position = n;
        var i = "translateY(" + n + "px) translateZ(0)";
        this._element.style.webkitTransform = i,
        this._element.style.transform = i
    },
    a.prototype.onTouchEnd = function(t, n, i) {
        var o = this;
        return console.log("onTouchEnd", n, i.y),
        this._position > -this._extent && this._position < 0 && (Math.abs(n) < 34 && Math.abs(i.y) < 300 || Math.abs(i.y) < 150) ? void o.snap() : (this._scroll.set(this._position, i.y), void(this._animation = e(this._scroll,
        function() {
            var e = o._scroll.x();
            o._position = e;
    ...
    a.prototype.onTransitionEnd = function() {
        ...
        "function" == typeof this.snapCallback && this.snapCallback(Math.floor(Math.abs(this._position) / this._itemHeight))
    },
    a.prototype.snap = function() {
        var e = this._itemHeight,
        t = this._position % e,
        n = Math.abs(t) > 17 ? this._position - (e - Math.abs(t)) : this._position - t;
        console.log("snap", this._position, n),
    ...
    a.prototype.update = function(e) {
        ...
        "number" == typeof e && (this._position = -e * this._itemHeight),
        this._position < -t ? this._position = -t: this._position > 0 && (this._position = 0),
        this._element.style.transform = "translateY(" + this._position + "px) translateZ(0)",
        this._extent = t,
    ...
    window.exparser.registerElement({
        ...
        detached: function() {
            ...
            this.$.main.removeEventListener("mousedown", this.__handleTouchStart),
            document.body.removeEventListener("mousemove", this.__handleTouchMove),
            document.body.removeEventListener("mouseup", this.__handleTouchEnd)
        },
        ...
        _setHeight: function(e) {
            for (var t = this.$.indicator.offsetHeight,
        ...
        _init: function() {
            ...
            this._handlers = new a(this.$.content, this._current, this._itemHeight),
            ...
            this.$.main.addEventListener("mousedown", this.__handleTouchStart),
            document.body.addEventListener("mousemove", this.__handleTouchMove),
            document.body.addEventListener("mouseup", this.__handleTouchEnd)
        },
        _update: function() {
        ...
        _findDelta: function(e) {
            ...
            for (var n = e.changedTouches || e.touches,
            i = 0; i < n.length; i++) if (n[i].identifier == t.trackingID) return {
                x: n[i].pageX - t.x,
                y: n[i].pageY - t.y
            };
            return null
            ...
            if (t.trackingID == -1) {
                ...
                if (n) {
                    if ("touchstart" == e.type) {
                        ...
                        t.trackingID = i[0].identifier,
                        t.x = i[0].pageX,
                        t.y = i[0].pageY
                    } else t.trackingID = "mouse",
                    t.x = e.screenX,
                    t.y = e.screenY;
                    t.maxDx = 0,
                    t.maxDy = 0,
        ...
        _handleTouchMove: function(e) {
            ...
            if (t.trackingID != -1) {
                ...
                if (n) {
                    for (t.maxDy = Math.max(t.maxDy, Math.abs(n.y)), t.maxDx = Math.max(t.maxDx, Math.abs(n.x)), t.historyX.push(n.x), t.historyY.push(n.y), t.historyTime.push(e.timeStamp); t.historyTime.length > 10;) t.historyTime.shift(),
                    t.historyX.shift(),
                    t.historyY.shift();
        ...
        _handleTouchEnd: function(e) {
            ...
            if (t.trackingID != -1) {
                ...
                if (n) {
                    ...
                    if (o > 2) for (var a = t.historyTime.length - 1,
                    s = t.historyTime[a], l = t.historyX[a], c = t.historyY[a]; a > 0;) {
                        a--;
                        var d = t.historyTime[a],
                        u = s - d;
                        if (u > 30 && u < 50) {
                            r.x = (l - t.historyX[a]) / (u / 1e3),
                            r.y = (c - t.historyY[a]) / (u / 1e3);
                            break
                        }
                    }
                    t.historyTime = [],
                    t.historyX = [],
                    t.historyY = [],
                    i && i.onTouchEnd && i.onTouchEnd(n.x, n.y, r)
                }
            }
        }
    })
...
window.exparser.registerElement({
    ...
    showSelector: function(e) {
        var t = this;
        if (!this.disabled) {
            var n = parseInt(this.value); (isNaN(n) || n >= this.range.length) && (n = 0);
            var i = [];
            ...
            function(e) { / :ok / .test(e.errMsg) && (t.value = e.index, t.triggerEvent("change", {
                    value: t.value
                })),
                t.resetPickerState(),
    ...
    showDatePickerView: function() {
        ...
        function(t) { / :ok / .test(t.errMsg) && (e.value = t.value, e.triggerEvent("change", {
                value: e.value
            })),
            e.resetPickerState(),
            e.formGetDataCallback()
        }), this.__pickerShow = !0)
    },
...
window.exparser.registerElement({
    ...
    activeAnimation: function(e) {
        if (!isNaN(this.percent)) if (e) {
            ...
            this.curPercent = 0,
            this.__timerId = setInterval(t.bind(this), 30),
            t.call(this)
...
window.exparser.registerElement({
    ...
    removeItem: function(e) {
        e.checked && (this.value = "", this._selectedItem = null)
    },
    renameItem: function(e, t) {
        e.checked && (this.value = t)
    },
    changed: function(e) {
...
window.exparser.registerElement({
    ...
    attached: function() {
        ...
        this.__handleTouchStart = function(t) {
            ...
            function() {});
            var n = e.$.main;
            e._touchScrollTop = e.$.main.scrollTop,
            e._touchScrollLeft = e.$.main.scrollLeft,
            e._touchScrollBottom = e._touchScrollTop + n.offsetHeight === n.scrollHeight,
            e._touchScrollRight = e._touchScrollLeft + n.offsetWidth === n.scrollWidth
        },
        ...
        if (!/wechatdevtools/.test(t) && /iphone/.test(t)) {
            ...
            var n = document.createElement("div");
            n.setAttribute("style", "position: fixed; left: 0; bottom: 0; line-height: 1; font-size: 1px; z-index: 10000; border-radius: 4px; box-shadow: 0 0 8px rgba(0,0,0,.4); width: 1px; height: 1px; overflow: hidden;"),
            n.innerText = ".",
            n.id = "__scroll_view_hack",
    ...
    _handleScroll: function(e) {
        this._bounce || (clearTimeout(this._timeout), this._timeout = setTimeout(function() {
            ...
            this.scrollTop = this._lastScrollTop = e.scrollTop,
            this.scrollLeft = this._lastScrollLeft = e.scrollLeft
        }.bind(this), 50))
    },
    _checkBounce: function() {
        var e = this,
        t = e.$.main;
        0 === e._touchScrollTop && (!e._bounce && t.scrollTop < 0 && (e._bounce = !0), e._bounce && t.scrollTop > 0 && (e._bounce = !1)),
        0 === e._touchScrollLeft && (!e._bounce && t.scrollLeft < 0 && (e._bounce = !0), e._bounce && t.scrollLeft > 0 && (e._bounce = !1)),
        e._touchScrollBottom && (!e._bounce && t.scrollTop > e._touchScrollTop && (e._bounce = !0), e._bounce && t.scrollTop < e._touchScrollTop && (e._bounce = !1)),
        e._touchScrollRight && (!e._bounce && t.scrollLeft > e._touchScrollLeft && (e._bounce = !0), e._bounce && t.scrollLeft < e._touchScrollLeft && (e._bounce = !1))
    },
    ...
    _srollIntoViewChanged: function(e) {
        if (e) {
            if (Number(e[0]) >= 0 && Number(e[0]) <= 9) return console.group('scroll-into-view="' + e + '" 有误'),
...
window.exparser.registerElement({
    ...
    _updateViewport: function(e, t) {
        ...
        r = function(r) {
            ...
            var s = !1;
            t && (i <= e ? i - 1 <= r && r <= e + 1 && (s = !0) : e - 1 <= r && r <= i + 1 && (s = !0)),
            s ? n._updateItemPos(a, r - e, r - i) : n._updateItemPos(a, r - e)
        };
        if (i < e) for (var a = Math.ceil(e), s = 0; s < o; s++) r(s + a - o + 1);
        else for (var l = Math.floor(e), c = 0; c < o; c++) r(c + l)
    },
    _updateDots: function(e) {
        ...
        for (var n = document.createDocumentFragment(), i = 0; i < this._slideCount; i++) {
            ...
            o.setAttribute("data-dot-index", i),
            i === e ? o.setAttribute("class", "wx-swiper-dot wx-swiper-dot-active") : o.setAttribute("class", "wx-swiper-dot"),
            n.appendChild(o)
        }
        t.appendChild(n)
    },
    _gotoSlide: function(e, t) {
        if (this._slideCount) {
            if (this._updateDots(e), this.circular && this._slideCount > 1) {
                ...
                t > 0 ? o < n && (o += this._slideCount) : t < 0 && o > n && (o -= this._slideCount),
                this._updateViewport(o, !0)
    ...
    _updateItemPos: function(e, t, n) {
        if (void 0 !== n || this._itemPos[e] !== t) {
            ...
            o = "",
            r = "";
            void 0 !== n && (i = this.duration + "ms", r = this.vertical ? "translate(0," + 100 * n + "%) translateZ(0)": "translate(" + 100 * n + "%,0) translateZ(0)"),
            o = this.vertical ? "translate(0," + 100 * t + "%) translateZ(0)": "translate(" + 100 * t + "%,0) translateZ(0)",
            this._items[e]._setTransform(i, o, r)
        }
    },
    ...
    _scheduleNextSlide: function() {
        var e = this;
        this._cancelSchedule(),
        this._attached && (this._scheduleTimeoutObj = setTimeout(function() {
            e._scheduleTimeoutObj = null,
            e._nextDirection = 1,
            e.current++
        },
        this.interval))
    ...
    _currentSlideChanged: function(e, t) {
        this._gotoSlide(e, this._nextDirection || 0),
        this._nextDirection = 0,
        e !== t && this.triggerEvent("change", {
            current: this.current
        })
    },
    _itemChanged: function(e) {
        return e.target._relatedSwiper = this,
        this._initSlides(),
        !1
    },
    ...
    _handleTrackMove: function(e) {
        ...
        r = function(e, n) {
            ...
            t._contentTrackSpeed = .6 * t._contentTrackSpeed + .4 * n,
            t.circular && t._slideCount > 1 || (r < 0 || r > i - 1) && (r < 0 ? r = -o( - r) : r > i - 1 && (r = i - 1 + o(r - (i - 1))), t._contentTrackSpeed = 0),
            t._updateViewport(r, !1)
        };
    ...
    _handleTrackEnd: function() {
        ...
        this.current !== t ? (this._nextDirection = this._contentTrackSpeed, this.current = t) : this._gotoSlide(t, 0),
        this.autoplay && this._scheduleNextSlide()
    },
    _handleContentTrack: function(e) {
        if ("start" === e.detail.state) return this._userTracking = !0,
        this._userWaitingCancelTap = !1,
...
function() {
    ...
    i = function(i, o) {
        ...
        var a = function e() {
            ...
            for (var i = 0; i < n.length; i++) {
                var o = n[i];
                o.frames--,
                o.frames || (o.func.call(o.self), n.splice(i--, 1))
            }
            t = n.length ? requestAnimationFrame(e) : null
        };
        return t || (t = requestAnimationFrame(a)),
        r
    },
    o = function(e) {
    ...
    window.exparser.registerElement({
        ...
        _setTransform: function(e, t, n) {
            n ? (console.info(arguments), this.$$.style.transitionDuration = "0ms", this.$$.style.transform = n, this._pendingTransform = t, this._pendingTimeoutId = i(this,
            function() {
                this.$$.style.transitionDuration = e,
                this.$$.style.transform = t
            })) : (this._clearTransform(), this.$$.style.transitionDuration = e, this.$$.style.transform = t)
        },
        _clearTransform: function() {
            this.$$.style.transitionDuration = "0ms",
            this._pendingTimeoutId && (this.$$.style.transform = this._pendingTransform, o(this._pendingTimeoutId), this._pendingTimeoutId = 0)
        }
    })
} (),
window.exparser.registerElement({
    ...
    onInputChange: function(e) {
        ...
        this.disabled ? void(this.checked = !this.checked) : void this.triggerEvent("change", {
            value: this.checked
        })
    },
    isSwitch: function(e) {
...
window.exparser.registerElement({
    ...
    _update: function() {
        for (var e = this.$.raw,
        t = document.createDocumentFragment(), n = 0, i = e.childNodes.length; n < i; n++) {
...
function() { / wechatdevtools / .test(window.navigator.userAgent.toLowerCase()) && window.exparser.registerElement({
        ...
        focusChanged: function(e, t) {
            return this.couldFocus(Boolean(e)),
            e
        },
        attached: function() {
            var e = this;
        ...
        getComputedStyle: function() {
            ...
            o = this.$.textarea;
            o.style.width = t.width - n[0] - n[1] + "px",
            o.style.height = t.height - i[0] - i[1] + "px",
            o.style.fontWeight = e.fontWeight,
            o.style.fontSize = e.fontSize || "16px",
            o.style.color = e.color,
            this.$.compute.style.fontSize = e.fontSize || "16px",
            this.$.compute.style.width = o.style.width,
            this.$.placeholder.style.width = o.style.width,
            this.$.placeholder.style.height = o.style.height,
            this.disabled ? o.setAttribute("disabled", !0) : o.removeAttribute("disabled"),
        ...
        getCurrentRows: function(e) {
            ...
            return this.$.compute.innerText = e,
        ...
        defaultValueChange: function(e) {
            return this.maxlength > 0 && e.length > this.maxlength && (e = e.slice(0, this.maxlength)),
            this.checkPlaceholderStyle(e),
            this.$.textarea.value = e,
            this.__attached && this.checkRows(e),
            e
        },
...
function() { / wechatdevtools / .test(window.navigator.userAgent.toLowerCase()) || window.exparser.registerElement({
        ...
        attached: function() {
            ...
            document.addEventListener("pageReRender", this.__reRenderCallback, !1),
            this.__onKeyboardShowId = exparser.addListenerToElement(document, "onKeyboardShow", this.onKeyboardShow.bind(this)),
            this.__onKeyboardCompleteId = exparser.addListenerToElement(document, "onKeyboardComplete", this.onKeyboardComplete.bind(this)),
            this.__onTextAreaHeightChangeId = exparser.addListenerToElement(document, "onTextAreaHeightChange", this.onTextAreaHeightChange.bind(this)),
            this.__onKeyboardConfirmId = exparser.addListenerToElement(document, "onKeyboardConfirm", this.onKeyboardConfirm.bind(this)),
            this.__routeDoneId = exparser.addListenerToElement(document, "routeDone",
            function() {
                e.checkAutoFocus()
        ...
        detached: function() {
            this.__detached = !0,
            document.removeEventListener("pageReRender", this.__reRenderCallback, !1),
            exparser.removeListenerFromElement(document, "onKeyboardShow", this.__onKeyboardShowId),
            exparser.removeListenerFromElement(document, "onKeyboardComplete", this.__onKeyboardCompleteId),
            exparser.removeListenerFromElement(document, "onTextAreaHeightChange", this.__onTextAreaHeightChangeId),
            exparser.removeListenerFromElement(document, "routeDone", this.__routeDoneId),
            exparser.removeListenerFromElement(document, "onKeyboardConfirm", this.__onKeyboardConfirmId),
            this.removeTextArea()
        },
        ...
        getComputedStyle: function() {
            ...
            isNaN(o) ? o = e.fontWeight: o < 500 ? o = "normal": o >= 500 && (o = "bold"),
            ...
            return this.autoHeight || (r.height = t.height - this.invalidHeight),
            r
        },
        getPlaceholderStyle: function() {
            var e = this.$.placeholder,
        ...
        insertTextArea: function() {
            ...
            WeixinJSBridge.invoke("insertTextArea", this.args,
            function(t) {
                if (/:ok/.test(t.errMsg)) {
        ...
        updateTextArea: function(e) {
            ...
            n && (n.inputId = this._inputId, WeixinJSBridge.invoke("updateTextArea", n,
            function(n) {
        ...
        defaultValueChange: function(e, t) {
            return this.maxlength > 0 && e.length > this.maxlength && (e = e.slice(0, this.maxlength)),
            this.textAreaValue != e && this.updateTextArea({
                value: e
            }),
            e
        },
...
"ios" !== wx.getPlatform() && window.exparser.registerElement({
    ...
    enableDanmuChanged: function(e, t) {
        this._danmuStatus = e ? "active": "",
        this.$.danmu.style.zIndex = e ? "0": "-9999"
    },
    actionChanged: function(e, t) {
        if ("object" === ("undefined" == typeof e ? "undefined": _typeof(e))) {
            ...
            else if ("seek" === n) this.$.player.currentTime = i[0],
            this._resetDanmu();
            else if ("sendDanmu" === n) {
    ...
    onPlay: function(e) {
        ...
        Array.prototype.forEach.apply(n, [function(e) {
            ...
            e.style.transitionDuration = n + "s",
            e.style.webkitTransitionDuration = n + "s"
        }])
    },
    onPause: function(e) {
    ...
    _setProgress: function(e) {
        this._progressLength = Math.floor(this.$.progress.offsetWidth * e),
    ...
    default.style.display = "",
        ...
        this.$.button.onclick = function(e) {
            e.stopPropagation(),
            t.$.player[t._buttonType]()
        },
        this.$.progress.onclick = function(e) {
            e.stopPropagation();
            var n = t._computeRate(e.clientX);
            t.$.player.currentTime = t.$.player.duration * n,
            t._resetDanmu()
        },
        this.$.fullscreen.onclick = function(e) {
            e.stopPropagation(),
            "android" === wx.getPlatform() ? t.enableFullScreen = !0 : t.enableFullScreen = !t.enableFullScreen,
            t.enableFullScreen && t.$.player.webkitEnterFullscreen(),
            t.triggerEvent("togglefullscreen", {
                enable: t.enableFullScreen
            })
        },
        this.$.danmuBtn.onclick = function(e) {
            e.stopPropagation(),
            t.enableDanmu = !t.enableDanmu,
            t.triggerEvent("toggledanmu", {
                enable: t.enableDanmu
            })
        },
        WeixinJSBridge.subscribe("video_" + this.id + "_actionChanged",
        function(t) {
            e.action = t,
            e.actionChanged(t)
        })
    ...
    onBallTouchStart: function() {
        ...
        var t = function(t) {
            t.stopPropagation(),
            t.preventDefault(),
            e._rate = e._computeRate(t.touches[0].clientX),
            e._setProgress(e._rate)
        },
        n = function n(i) {
            e.$.player.currentTime = e.$.player.duration * e._rate,
            document.removeEventListener("touchmove", t),
            document.removeEventListener("touchend", n),
            e._isLockTimeUpdateProgress = !1,
            e._resetDanmu()
        };
    ...
    _resetDanmu: function() {
        ...
        Object.keys(this.danmuObject).forEach(function(t) {
...
"ios" === wx.getPlatform() && window.exparser.registerElement({
    ...
    _update: function(e, t) {
        ...
        e.hide = this.hidden;
        var i = this._getData();
        e.needEvent = Object.keys(i.handlers).length > 0,
        e.objectFit = this.objectFit,
        this.duration > 0 && (args.duration = duration),
        WeixinJSBridge.invoke("updateVideoPlayer", e,
        function(e) { / ok / .test(e.errMsg) || n._publish("error", {
                errMsg: e.errMsg
            })
        })
    },
...
function() {
    var t = function() {
        if (n < r) {
            ...
            e.$$.style.transitionProperty = s,
            e.$$.style.transform = l,
            e.$$.style.transformOrigin = c,
            e.$$.style.webkitTransition = a,
            e.$$.style.webkitTransitionProperty = s,
            e.$$.style.webkitTransform = l,
            e.$$.style.webkitTransformOrigin = c;
...
function(e, t) {
    ...
    t.dashToCamelCase = function(e) {
        return n[e] ? n[e] : n[e] = e.indexOf("-") <= 0 ? e: e.replace(i.dashToCamel,
        function(e) {
...
function(e, t, n) {
    ...
    t.diffNode = function(e, t, n, i) {
        if (e !== t) {
            var o = n[i];
            if (null == t) o = g(o, new r.
        default(d.PATCH_TYPE.REMOVE, e));
            else if ((0, l.isVirtualNode)(t)) if ((0, l.isVirtualNode)(e)) if (e.tagName === t.tagName && e.wxKey === t.wxKey) if ("virtual" === e.tagName && e.wxVkey !== t.wxVkey) o = g(o, new r.
        default(d.PATCH_TYPE.VNODE, e, t));
            else {
                var a = p(t.props, t.newProps);
                a && (o = g(o, new r.
            default(d.PATCH_TYPE.PROPS, e, a))),
                o = h(e, t, n, o, i)
            } else o = g(o, new r.
        default(d.PATCH_TYPE.VNODE, e, t));
            else o = g(o, new r.
        default(d.PATCH_TYPE.VNODE, e, t));
                ...
                t.text !== e.text && (o = g(o, new r.
            default(d.PATCH_TYPE.TEXT, e, t)))
            }
            o && (n[i] = o)
        }
    }),
    h = t.diffChildren = function(e, t, n, i, o) {
        for (var a = e.children,
        s = (0, c.listDiff)(a, t.children), h = s.children, p = a.length > h.length ? a.length: h.length, f = 0; f < p; ++f) {
            var v = a[f],
            m = h[f]; ++o,
            v ? u(v, m, n, o) : m && (i = g(i, new r.
        default(d.PATCH_TYPE.INSERT, v, m))),
            (0, l.isVirtualNode)(v) && (o += v.descendants)
        }
        return s.moves && (i = g(i, new r.
    default(d.PATCH_TYPE.REORDER, e, s.moves))),
        i
    },
    ...
    s = function() {
        ...
        return o(e, [{
            ...
            value: function(e, t) {
                var n = e.parentNode,
                i = t.render();
                return n && i !== e && n.replaceChild(i, e),
                i
            }
        },
        {
        ...
        },
        {
            ...
            value: function(e, t, n) {
                return (0, r.applyProperties)(e, t, n),
                e
            }
        },
        {
...
function(e, t) {
    ...
    t.mapIndexToDom = function e(t, n, o, r, a) {
        if (t) {
            i(o, a, a) && (r[a] = t);
            var s = n.children;
            if (s) for (var l = t.childNodes,
            c = 0; c < s.length; ++c) {
                var d = s[c]; ++a;
                var u = a + (d.descendants || 0);
                i(o, a, u) && e(l[c], d, o, r, a),
                a = u
            }
        }
    }),
...
function(e, t, n) {
    ...
    o = (t.listDiff = function(e, t) {
        ...
        for (var y = u.slice(0), x = 0, C = [], k = [], E = 0; E < t.length;) {
            for (var S = t[E], T = r(S), I = y[x], B = r(I); null === I;) C.push(n(y, x, B)),
            I = y[x],
            B = r(I);
...
function(e, t) {
    ...
    o.prototype.type = "WxVirtualText",
    t.
default = o
},
function(e, t, n) {
...
function(e, t, n) {
    ...
    t.getObjectByPath = function(e, t, n) {
        ...
        a = e,
        s = !1,
        l = 0; l < t.length; l++) Number(t[l]) === t[l] && t[l] % 1 === 0 ? "Array" !== (0, i.getDataType)(a) && (n && !s ? (s = !0, o[r] = {
            __value__: [],
            __wxspec__: !0
        },
        ...
        o = a,
        a = a[t[l]],
        a && a.__wxspec__ && (a = a.__value__, s = !0);
        return {
            obj: o,
            key: r,
            changed: s
...
function(e, t, n) {
    ...
    t.enablePullUpRefresh = function() {
        window.__enablePullUpRefresh__ && !
        function() {
            window.onscroll = function() {
                s() && d()
            };
            var e = 0;
            window.__DOMTree__.addListener("touchstart",
            function(t) {
                e = t.touches[0].pageY,
                l = !1
            }),
            window.__DOMTree__.addListener("touchmove",
            function(t) {
                if (!l) {
                    var n = t.touches[0].pageY;
                    n < e && s() && (d(), l = !0)
            ...
            window.__DOMTree__.addListener("touchend",
            function(e) {
                l = !1
            })
        } ()
